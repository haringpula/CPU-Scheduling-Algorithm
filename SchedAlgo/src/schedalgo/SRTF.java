...
public class SRTF {
    ...
    public static void main() throws IOException {
        ...
        System.out.print("Please Enter no. of Processes: ");
        proc_ctr = Integer.parseInt(br.readLine());
        System.out.println("-------------------------------------------------");

        int proc[][] = new int[proc_ctr + 1][4]; //proc[][0] is the AT array,[][1] - RT,[][2] - WT,[][3] - TT
        for(int i = 1; i <= proc_ctr; i++){
        ...
        //the new Process
        {
        System.out.print(" | ET: " + i + " | P" + sel_proc);
        }
    }
     ...
     //Printing the WT and TT for each Process
        System.out.println("Processes\t Waiting Time \t\t Turn-around Time ");
        for(int i = 1; i <= proc_ctr; i++){
        ...
        System.out.println("CPU utilization : " + (total_bt/(total_time-1))*100 + "%");
    }
}